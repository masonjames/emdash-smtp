...
describe("@masonjames/emdash-smtp-marketplace descriptor", () => {
	it("is a standard plugin descriptor for the EmDash SMTP marketplace distribution", () => {
		...
		expect(descriptor.entrypoint).toBe("@masonjames/emdash-smtp-marketplace/sandbox");
...
describe("@masonjames/emdash-smtp-marketplace runtime", () => {
